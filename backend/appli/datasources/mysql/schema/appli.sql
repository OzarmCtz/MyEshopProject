...
-- Dumping database structure for shop-mysql
CREATE DATABASE IF NOT EXISTS `shop-mysql` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `shop-mysql`;

-- Dumping structure for table shop-mysql.app_settings
...
-- Dumping structure for table shop-mysql.discount
...
-- Dumping structure for table shop-mysql.discount_link
...
-- Dumping structure for table shop-mysql.groups_privileges
...
-- Dumping structure for table shop-mysql.groups_privileges_link
...
-- Dumping structure for table shop-mysql.groups_users
...
-- Dumping structure for table shop-mysql.groups_users_link
...
-- Dumping structure for table shop-mysql.items
...
-- Dumping structure for table shop-mysql.items_category
...
-- Dumping structure for table shop-mysql.items_category_link
...
-- Dumping structure for table shop-mysql.items_purshased
...
-- Dumping structure for table shop-mysql.items_reviews
...
-- Dumping structure for table shop-mysql.items_sub_category
...
-- Dumping structure for table shop-mysql.items_sub_category_link
...
-- Dumping structure for table shop-mysql.transactions
...
-- Dumping structure for table shop-mysql.users
...
-- Dumping structure for table shop-mysql.users_basket
...
-- Dumping structure for table shop-mysql.users_wishlist
